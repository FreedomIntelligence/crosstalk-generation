...
:tada: 数据类型包括单口相声、对口相声、群口相声以及小品

:tada: 因本项研究仅针对于对口相声，故提供的训练集中仅包括对口相声，如需其他类型，请参见 **数据描述-初始数据** 模块。
...
GPT3生成的短文本 : [中文](https://github.com/anonNo2/crosstalk-generation/blob/main/GPT3-Generate-Samples/Short-Sample.zh-CN.md) [英文](https://github.com/anonNo2/crosstalk-generation/blob/main/GPT3-Generate-Samples/Short-Sample.en-US.md)  
GPT3生成的长文本 :[中文](https://github.com/anonNo2/crosstalk-generation/blob/main/GPT3-Generate-Samples/Long-Sample.zh-CN.md) [英文](https://github.com/anonNo2/crosstalk-generation/blob/main/GPT3-Generate-Samples/Long-Sample.en-US.md)
